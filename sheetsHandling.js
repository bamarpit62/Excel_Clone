...
addSheetBtn.addEventListener("click", (e) => {
    ...
    handleSheetRemovel(sheet);
    sheet.click();

})
function handleSheetRemovel(sheet){
    sheet.addEventListener("mousedown", (e) => {
       if(e.button != 2 ){
        return;
       }          //0 -> left, 1 -> scroll, 2 -> right click
       let allSheetFolders = document.querySelectorAll(".sheet-folder");
       if(allSheetFolders.length == 1){
        alert("Yout need to have atleast one sheet!");
        return;
       }
        ...
        //BY default asign DB to  sheet 1 to (active)
